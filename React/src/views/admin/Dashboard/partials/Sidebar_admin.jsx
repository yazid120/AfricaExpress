        ...
        <ul className="pb-2 space-y-2">
          ...
          <li>
            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
              ...
              <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="true">Layouts</span>
          ...
          <li>
            ...
            <ul id="dropdown-crud">
              ...
              <li>
                ...
                group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
          ...
          <li>
            ...
            <ul id="dropdown-pages" className="hidden py-2 space-y-2">
              <li>
                <a  className="flex items-center cursor-pointer	 p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pricing</a>
              </li>
              <li>
                <a  className="flex items-center cursor-pointer	 p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Maintenance</a>
              </li>
              <li>
                <a  className="flex items-center cursor-pointer	 p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">404 not found</a>
              </li>
              <li>
                <a className="flex items-center cursor-pointer	 p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">500 server error</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul id="dropdown-playground" className="space-y-2 py-2">
              <li>
                <a className="text-base text-gray-900 cursor-pointer rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700">Stacked</a>
              </li>
              <li>
                <a className="text-base text-gray-900 cursor-pointer rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700">Sidebar</a>
              </li>
            </ul>
          </li>
        </ul>
