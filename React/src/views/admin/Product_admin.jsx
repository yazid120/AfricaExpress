...
<div style={{
  ...
  {/*
  <div className="modal__overlay fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
    <div className="modal bg-white p-4 rounded-lg shadow-lg">
      <div className="modal__msg"></div>
      <div className="modal__cta">
        <button className="btn modal__btn bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded" type="button">
          OK
        </button>
      </div>
    </div>
